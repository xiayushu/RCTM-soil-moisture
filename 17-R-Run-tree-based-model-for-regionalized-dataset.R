...
all <- read.table('data_with_RAP_qa.csv', comment.char="", quote = "\"", header=T, sep=",")
...
saveRDS(model_full, "./moisture_model_RAP.rds")
...
write.csv(cali_full_results, "cali_RAP_results.csv", row.names = F) 
...
write.csv(vali_full_results, "vali_RAP_results.csv", row.names = F) 